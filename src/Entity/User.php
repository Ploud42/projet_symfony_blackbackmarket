...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    public function addOrdersSeller(Order $ordersSeller): self
    {
        if (!$this->orders_seller->contains($ordersSeller)) {
            $this->orders_seller[] = $ordersSeller;
    ...
    public function removeOrdersSeller(Order $ordersSeller): self
    {
